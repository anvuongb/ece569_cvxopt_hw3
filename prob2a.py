...
plt.title("Problem 2A - Separable C-Hull - Plot training data")
plt.xlabel("X")
plt.ylabel("Y")
...
# plt.show()
plt.tight_layout()
fig.savefig("./figures/plot_2a_c_hull_training_data.png")
...
plt.title("Problem 2A - Separable C-Hull - Plot test data")
plt.xlabel("X")
plt.ylabel("Y")
plt.legend(loc="upper left")
ax = plt.gca()
...
# plt.show()
plt.tight_layout()
fig.savefig("./figures/plot_2a_c_hull_testing_data.png")
#######################
### END CONVEX HULL ###
#######################
...
plt.title("Problem 2A - Overlap C-Hull - Plot training data")
plt.xlabel("X")
plt.ylabel("Y")
plt.legend(loc="upper left")
ax = plt.gca()
...
# plt.show()
plt.tight_layout()
fig.savefig("./figures/plot_2a_reduced_c_hull_training_data.png")
...
plt.title("Problem 2A - Overlap C-Hull - Plot test data")
plt.xlabel("X")
plt.ylabel("Y")
plt.legend(loc="upper left")
ax = plt.gca()
